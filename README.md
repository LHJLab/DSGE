[![R-CMD-check](https://github.com/LHJLab/DSGE/actions/workflows/R-CMD-check.yaml/badge.svg?branch=dev_v1.2.0_cpp_null)](https://github.com/LHJLab/DSGE/actions/workflows/R-CMD-check.yaml)
